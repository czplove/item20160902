...
PGM_P PGM emberCommandTableZdoUnbindGroupCommandArguments[] = {
  "Target node ID",
...
PGM_P PGM emberCommandTableZdoUnbindUnicastCommandArguments[] = {
  "Target node ID",
  "The source EUI64 of the binding (the remote device's EUI64)",
  "The source endpoint of the binding.",
  "The cluster ID to unbind.",
...
EmberCommandEntry emberCommandTableZdoUnbindCommands[] = {
...
PGM_P PGM emberCommandTableZdoOutClListAddCommandArguments[] = {
  "Client cluster ids",
  NULL
};

EmberCommandEntry emberCommandTableZdoOutClListCommands[] = {
...
PGM_P PGM emberCommandTableZdoNwkUpdChanCommandArguments[] = {
  "One byte channel to change to.",
  NULL
};

PGM_P PGM emberCommandTableZdoNwkUpdScanCommandArguments[] = {
...
PGM_P PGM emberCommandTableZdoNwkUpdSetCommandArguments[] = {
  "Two byte network manager id",
  "Four byte channel mask",
  NULL
};

EmberCommandEntry emberCommandTableZdoNwkUpdCommands[] = {
...
PGM_P PGM emberCommandTableZdoInClListAddCommandArguments[] = {
  "Server cluster id",
  NULL
};

EmberCommandEntry emberCommandTableZdoInClListCommands[] = {
...
PGM_P PGM emberCommandTableZclWindowCoveringGoToLiftPercentCommandArguments[] = {
  "percentage lift value",
  NULL
};

PGM_P PGM emberCommandTableZclWindowCoveringGoToLiftValueCommandArguments[] = {
  "lift value",
  NULL
};

PGM_P PGM emberCommandTableZclWindowCoveringGoToTiltPercentageCommandArguments[] = {
  "percentage tilt value",
  NULL
};

PGM_P PGM emberCommandTableZclWindowCoveringGoToTiltValueCommandArguments[] = {
  "tilt value",
  NULL
};

EmberCommandEntry emberCommandTableZclWindowCoveringCommands[] = {
  ...
  emberCommandEntryActionWithDetails("go-to-lift-percent", zclWindowCoveringGoToLiftPercentCommand, "u", "Goto lift percentage specified", emberCommandTableZclWindowCoveringGoToLiftPercentCommandArguments),
  emberCommandEntryActionWithDetails("go-to-lift-value", zclWindowCoveringGoToLiftValueCommand, "v", "Goto lift value specified", emberCommandTableZclWindowCoveringGoToLiftValueCommandArguments),
  emberCommandEntryActionWithDetails("go-to-tilt-percentage", zclWindowCoveringGoToTiltPercentageCommand, "u", "Goto tilt percentage specified", emberCommandTableZclWindowCoveringGoToTiltPercentageCommandArguments),
  emberCommandEntryActionWithDetails("go-to-tilt-value", zclWindowCoveringGoToTiltValueCommand, "v", "Goto tilt value specified", emberCommandTableZclWindowCoveringGoToTiltValueCommandArguments),
...
PGM_P PGM emberCommandTableZclTstatSetCommandArguments[] = {
  "mode",
  "amount",
  NULL
};

EmberCommandEntry emberCommandTableZclTstatCommands[] = {
  emberCommandEntryActionWithDetails("set", zclTstatSetCommand, "us", "Command description for SetpointRaiseLower", emberCommandTableZclTstatSetCommandArguments),
  emberCommandEntryTerminator()
};

EmberCommandEntry emberCommandTableZclTestResponseCommands[] = {
...
EmberCommandEntry emberCommandTableZclTestCommands[] = {
  emberCommandEntrySubMenu("response", emberCommandTableZclTestResponseCommands, ""),
  emberCommandEntryTerminator()
};

PGM_P PGM emberCommandTableZclScenesAddCommandArguments[] = {
  "group id",
  "scene id",
  "transition time",
  "scene name",
...
PGM_P PGM emberCommandTableZclScenesCopyCommandArguments[] = {
  "mode",
  "group id from",
  "scene id from",
  "group id to",
...
PGM_P PGM emberCommandTableZclScenesEaddCommandArguments[] = {
  "group id",
  "scene id",
  "transition time",
  "scene name",
...
PGM_P PGM emberCommandTableZclScenesEviewCommandArguments[] = {
  "group id",
  "scene id",
  NULL
};

PGM_P PGM emberCommandTableZclScenesGetCommandArguments[] = {
  "group id",
  NULL
};

PGM_P PGM emberCommandTableZclScenesRecallCommandArguments[] = {
  "group id",
  "scene id",
  NULL
};

PGM_P PGM emberCommandTableZclScenesRemoveCommandArguments[] = {
  "group id",
  "scene id",
  NULL
};

PGM_P PGM emberCommandTableZclScenesRmallCommandArguments[] = {
  "group id",
  NULL
};

PGM_P PGM emberCommandTableZclScenesStoreCommandArguments[] = {
  "group id",
  "scene id",
  NULL
};

PGM_P PGM emberCommandTableZclScenesViewCommandArguments[] = {
  "group id",
  "scene id",
  NULL
};

EmberCommandEntry emberCommandTableZclScenesCommands[] = {
...
PGM_P PGM emberCommandTableZclPollControlLongCommandArguments[] = {
  "new long poll interval",
  NULL
};

PGM_P PGM emberCommandTableZclPollControlShortCommandArguments[] = {
  "new short poll interval",
  NULL
};

EmberCommandEntry emberCommandTableZclPollControlCommands[] = {
...
PGM_P PGM emberCommandTableZclOtaConfigReadCommandArguments[] = {
  "token",
  NULL
};

PGM_P PGM emberCommandTableZclOtaConfigSetTokenCommandArguments[] = {
  "token",
  "data",
  NULL
};

PGM_P PGM emberCommandTableZclOtaConfigUnlockCommandArguments[] = {
  "data",
  NULL
};

EmberCommandEntry emberCommandTableZclOtaConfigCommands[] = {
...
PGM_P PGM emberCommandTableZclOnOffOffeffectCommandArguments[] = {
  "effect id",
  "effect variant",
  NULL
};

PGM_P PGM emberCommandTableZclOnOffOntimedoffCommandArguments[] = {
  "on off control",
  "on time",
  "off wait time",
  NULL
...
EmberCommandEntry emberCommandTableZclOnOffCommands[] = {
...
PGM_P PGM emberCommandTableZclMfglibRxModeCommandArguments[] = {
  "channel",
  "power",
  "time",
  NULL
...
PGM_P PGM emberCommandTableZclMfglibStreamCommandArguments[] = {
  "channel",
  "power",
  "time",
  NULL
...
PGM_P PGM emberCommandTableZclMfglibToneCommandArguments[] = {
  "channel",
  "power",
  "time",
  NULL
...
EmberCommandEntry emberCommandTableZclMfglibCommands[] = {
...
PGM_P PGM emberCommandTableZclMeteringChgSupplyCommandArguments[] = {
  "provider id",
  "issuer event id",
  "request date time",
...
PGM_P PGM emberCommandTableZclMeteringGetProfileCommandArguments[] = {
  "interval channel",
  "end time",
  "number of periods",
  NULL
...
PGM_P PGM emberCommandTableZclMeteringGetSampledDataCommandArguments[] = {
  "sample id",
...
PGM_P PGM emberCommandTableZclMeteringGetSnapshotCommandArguments[] = {
  "earliest start time",
  "latest end time",
  "snapshot offset",
  "snapshot cause",
...
PGM_P PGM emberCommandTableZclMeteringLocalChgSupplyCommandArguments[] = {
  "proposed supply status",
  NULL
};

PGM_P PGM emberCommandTableZclMeteringMirrorRemovedCommandArguments[] = {
  "endpoint id",
  NULL
};

PGM_P PGM emberCommandTableZclMeteringReqFastPollModeCommandArguments[] = {
  "fast poll update period",
  "duration",
  NULL
};

PGM_P PGM emberCommandTableZclMeteringRstLoadLimitCtrCommandArguments[] = {
  "provider id",
  "issuer event id",
  NULL
};

PGM_P PGM emberCommandTableZclMeteringSchSnapshotCommandArguments[] = {
  "issuer event id",
  "command index",
  "command count",
...
PGM_P PGM emberCommandTableZclMeteringSetSupplyStatusCommandArguments[] = {
  "issuer event id",
  "supply tamper state",
...
PGM_P PGM emberCommandTableZclMeteringSetUncntrlFlowThresholdCommandArguments[] = {
  "provider id",
  "issuer event id",
...
PGM_P PGM emberCommandTableZclMeteringStartSamplingCommandArguments[] = {
  "issuer event id",
  "start sampling time",
  "sample type",
...
PGM_P PGM emberCommandTableZclMeteringTakeSnapshotCommandArguments[] = {
  "snapshot cause",
  NULL
};

EmberCommandEntry emberCommandTableZclMeteringCommands[] = {
...
PGM_P PGM emberCommandTableZclLockLockCommandArguments[] = {
  "pin",
  NULL
};

PGM_P PGM emberCommandTableZclLockUnlockCommandArguments[] = {
  "pin",
  NULL
};

EmberCommandEntry emberCommandTableZclLockCommands[] = {
  emberCommandEntryActionWithDetails("lock", zclLockLockCommand, "b", "Locks the door", emberCommandTableZclLockLockCommandArguments),
  emberCommandEntryActionWithDetails("unlock", zclLockUnlockCommand, "b", "Unlocks the door", emberCommandTableZclLockUnlockCommandArguments),
  emberCommandEntryTerminator()
};
...
PGM_P PGM emberCommandTableZclIdentifyIdCommandArguments[] = {
  "identify time",
  NULL
};

PGM_P PGM emberCommandTableZclIdentifyOffCommandArguments[] = {
  "The endpoint on which to stop identifying",
  NULL
};

PGM_P PGM emberCommandTableZclIdentifyOnCommandArguments[] = {
  "The endpoint on the device which should begin identifying",
  "The number of seconds to spend identifying",
  NULL
};

PGM_P PGM emberCommandTableZclIdentifyTriggerCommandArguments[] = {
  "effect id",
  "effect variant",
  NULL
};

EmberCommandEntry emberCommandTableZclIdentifyCommands[] = {
...
PGM_P PGM emberCommandTableZclIasAceACommandArguments[] = {
  "arm mode",
  "arm disarm code",
  "zone id",
  NULL
...
PGM_P PGM emberCommandTableZclIasAceBCommandArguments[] = {
  "number of zones",
  "zone ids",
  "",
  "arm disarm code",
...
PGM_P PGM emberCommandTableZclIasAceGetziCommandArguments[] = {
  "zone id",
  NULL
};

EmberCommandEntry emberCommandTableZclIasAceCommands[] = {
  emberCommandEntryActionWithDetails("a", zclIasAceACommand, "ubu", "Command description for Arm", emberCommandTableZclIasAceACommandArguments),
  emberCommandEntryActionWithDetails("b", zclIasAceBCommand, "uu*b", "Command description for Bypass", emberCommandTableZclIasAceBCommandArguments),
  ...
  emberCommandEntryActionWithDetails("getzi", zclIasAceGetziCommand, "u", "Command description for GetZoneInformation", emberCommandTableZclIasAceGetziCommandArguments),
...
PGM_P PGM emberCommandTableZclGroupsAddCommandArguments[] = {
  "group id",
  "group name",
  NULL
};

PGM_P PGM emberCommandTableZclGroupsAddIfIdCommandArguments[] = {
  "group id",
  "group name",
  NULL
};

PGM_P PGM emberCommandTableZclGroupsGetCommandArguments[] = {
  "group count",
  "group list",
  "",
  NULL
...
PGM_P PGM emberCommandTableZclGroupsRemoveCommandArguments[] = {
  "group id",
  NULL
};

PGM_P PGM emberCommandTableZclGroupsViewCommandArguments[] = {
  "group id",
  NULL
};

EmberCommandEntry emberCommandTableZclGroupsCommands[] = {
...
PGM_P PGM emberCommandTableZclGlobalDirectionCommandArguments[] = {
  "The direction for global commands, 0 = client to server, 1 = server to ...",
  NULL
};

PGM_P PGM emberCommandTableZclGlobalDiscComGenCommandArguments[] = {
...
PGM_P PGM emberCommandTableZclGlobalDiscComRecCommandArguments[] = {
  "The cluster to find commands on.",
  "The command id to start the command search on.",
  "Max command ids to search for.",
  NULL
...
PGM_P PGM emberCommandTableZclGlobalDiscoverCommandArguments[] = {
...
PGM_P PGM emberCommandTableZclGlobalExpectReportFromMeCommandArguments[] = {
...
PGM_P PGM emberCommandTableZclGlobalNwriteCommandArguments[] = {
...
PGM_P PGM emberCommandTableZclGlobalReadCommandArguments[] = {
  "The cluster id of the cluster to read from.",
  "The attribute id of the attribute to read.",
  NULL
};

PGM_P PGM emberCommandTableZclGlobalReportCommandArguments[] = {
...
PGM_P PGM emberCommandTableZclGlobalReportReadCommandArguments[] = {
...
PGM_P PGM emberCommandTableZclGlobalSendMeAReportCommandArguments[] = {
...
PGM_P PGM emberCommandTableZclGlobalUwriteCommandArguments[] = {
...
PGM_P PGM emberCommandTableZclGlobalWriteCommandArguments[] = {
  "The cluster id of the cluster to write to.",
  "The attribute id of the attribute to write.",
  "The type of the attribute to write.",
  "The data to be written.",
...
EmberCommandEntry emberCommandTableZclGlobalCommands[] = {
...
PGM_P PGM emberCommandTableZclColorControlEmovehueCommandArguments[] = {
  "move mode",
  "rate",
  NULL
};

PGM_P PGM emberCommandTableZclColorControlEmovetohueCommandArguments[] = {
  "enhanced hue",
  "direction",
  "transition time",
  NULL
...
PGM_P PGM emberCommandTableZclColorControlEmovetohueandsatCommandArguments[] = {
  "enhanced hue",
  "saturation",
  "transition time",
  NULL
...
PGM_P PGM emberCommandTableZclColorControlEstephueCommandArguments[] = {
  "step mode",
  "step size",
  "transition time",
  NULL
...
PGM_P PGM emberCommandTableZclColorControlLoopCommandArguments[] = {
  "update flags",
  "action",
  "direction",
  "time",
...
PGM_P PGM emberCommandTableZclColorControlMovecolorCommandArguments[] = {
  "rate x",
  "rate y",
  NULL
};

PGM_P PGM emberCommandTableZclColorControlMovecolortempCommandArguments[] = {
  "move mode",
  "rate",
...
PGM_P PGM emberCommandTableZclColorControlMovehueCommandArguments[] = {
  "move mode",
  "rate",
  NULL
};

PGM_P PGM emberCommandTableZclColorControlMovesatCommandArguments[] = {
  "move mode",
  "rate",
  NULL
};

PGM_P PGM emberCommandTableZclColorControlMovetocolorCommandArguments[] = {
  "color x",
  "color y",
  "transition time",
  NULL
...
PGM_P PGM emberCommandTableZclColorControlMovetocolortempCommandArguments[] = {
  "color temperature",
  "transition time",
  NULL
};

PGM_P PGM emberCommandTableZclColorControlMovetohueCommandArguments[] = {
  "hue",
  "direction",
  "transition time",
  NULL
...
PGM_P PGM emberCommandTableZclColorControlMovetohueandsatCommandArguments[] = {
  "hue",
  "saturation",
  "transition time",
  NULL
...
PGM_P PGM emberCommandTableZclColorControlMovetosatCommandArguments[] = {
  "saturation",
  "transition time",
  NULL
};

PGM_P PGM emberCommandTableZclColorControlStepcolorCommandArguments[] = {
  "step x",
  "step y",
  "transition time",
  NULL
...
PGM_P PGM emberCommandTableZclColorControlStepcolortempCommandArguments[] = {
  "step mode",
  "step size",
  "transition time",
  "color temperature minimum",
...
PGM_P PGM emberCommandTableZclColorControlStephueCommandArguments[] = {
  "step mode",
  "step size",
  "transition time",
  NULL
...
PGM_P PGM emberCommandTableZclColorControlStepsatCommandArguments[] = {
  "step mode",
  "step size",
  "transition time",
  NULL
...
EmberCommandEntry emberCommandTableZclColorControlCommands[] = {
  ...
  emberCommandEntryActionWithDetails("movecolor", zclColorControlMovecolorCommand, "rr", "Moves the color.", emberCommandTableZclColorControlMovecolorCommandArguments),
  emberCommandEntryActionWithDetails("movecolortemp", zclColorControlMovecolortempCommand, "uvvv", "Command description for MoveColorTemperature", emberCommandTableZclColorControlMovecolortempCommandArguments),
  emberCommandEntryActionWithDetails("movehue", zclColorControlMovehueCommand, "uu", "Move hue up or down at specified rate.", emberCommandTableZclColorControlMovehueCommandArguments),
  emberCommandEntryActionWithDetails("movesat", zclColorControlMovesatCommand, "uu", "Move saturation up or down at specified rate.", emberCommandTableZclColorControlMovesatCommandArguments),
  emberCommandEntryActionWithDetails("movetocolor", zclColorControlMovetocolorCommand, "vvv", "Move to specified color.", emberCommandTableZclColorControlMovetocolorCommandArguments),
  emberCommandEntryActionWithDetails("movetocolortemp", zclColorControlMovetocolortempCommand, "vv", "Moves the lighting to a specific color temperature.", emberCommandTableZclColorControlMovetocolortempCommandArguments),
  emberCommandEntryActionWithDetails("movetohue", zclColorControlMovetohueCommand, "uuv", "Move to specified hue.", emberCommandTableZclColorControlMovetohueCommandArguments),
  emberCommandEntryActionWithDetails("movetohueandsat", zclColorControlMovetohueandsatCommand, "uuv", "Move to hue and saturation.", emberCommandTableZclColorControlMovetohueandsatCommandArguments),
  emberCommandEntryActionWithDetails("movetosat", zclColorControlMovetosatCommand, "uv", "Move to specified saturation.", emberCommandTableZclColorControlMovetosatCommandArguments),
  emberCommandEntryActionWithDetails("stepcolor", zclColorControlStepcolorCommand, "rrv", "Steps the lighting to a specific color.", emberCommandTableZclColorControlStepcolorCommandArguments),
  emberCommandEntryActionWithDetails("stepcolortemp", zclColorControlStepcolortempCommand, "uvvvv", "Command description for StepColorTemperatue", emberCommandTableZclColorControlStepcolortempCommandArguments),
  emberCommandEntryActionWithDetails("stephue", zclColorControlStephueCommand, "uuu", "Step hue up or down by specified size at specified rate.", emberCommandTableZclColorControlStephueCommandArguments),
  emberCommandEntryActionWithDetails("stepsat", zclColorControlStepsatCommand, "uuu", "Step saturation up or down by specified size at specified rate.", emberCommandTableZclColorControlStepsatCommandArguments),
...
EmberCommandEntry emberCommandTableZclBasicCommands[] = {
...
EmberCommandEntry emberCommandTableZclCommands[] = {
  ...
  emberCommandEntrySubMenu("ias-ace", emberCommandTableZclIasAceCommands, ""),
  ...
  emberCommandEntrySubMenu("lock", emberCommandTableZclLockCommands, ""),
  ...
  emberCommandEntrySubMenu("tstat", emberCommandTableZclTstatCommands, ""),
  emberCommandEntrySubMenu("window-covering", emberCommandTableZclWindowCoveringCommands, ""),
...
PGM_P PGM emberCommandTableSecurityMfgTokenSetCommandArguments[] = {
  "magic number",
  "value",
  NULL
};

EmberCommandEntry emberCommandTableSecurityMfgTokenCommands[] = {
#if !defined(EMBER_AF_HAS_SECURITY_PROFILE_NONE)
...
PGM_P PGM emberCommandTablePluginTrafficTestLevelCommandArguments[] = {
  "device entry",
  "ms between toggles",
  "num messages",
  NULL
...
PGM_P PGM emberCommandTablePluginTrafficTestOnOffCommandArguments[] = {
  "device entry",
  "ms between toggles",
  "num messages",
  NULL
...
EmberCommandEntry emberCommandTablePluginTrafficTestCommands[] = {
  emberCommandEntryActionWithDetails("level", emberTrafficTestLevelCommand, "vvv", "Start the level test.", emberCommandTablePluginTrafficTestLevelCommandArguments),
  emberCommandEntryActionWithDetails("on-off", emberTrafficTestOnOffCommand, "vvv", "Start the on/off test.", emberCommandTablePluginTrafficTestOnOffCommandArguments),
  emberCommandEntryTerminator()
};

EmberCommandEntry emberCommandTablePluginTestHarnessTcKeepaliveCommands[] = {
...
EmberCommandEntry emberCommandTablePluginTestHarnessStackLimitBeaconsCommands[] = {
...
EmberCommandEntry emberCommandTablePluginTestHarnessStackCommands[] = {
  emberCommandEntrySubMenu("limit-beacons", emberCommandTablePluginTestHarnessStackLimitBeaconsCommands, ""),
  emberCommandEntryTerminator()
};

EmberCommandEntry emberCommandTablePluginTestHarnessRegistrationCommands[] = {
...
EmberCommandEntry emberCommandTablePluginTestHarnessRadioCommands[] = {
...
PGM_P PGM emberCommandTablePluginTestHarnessPriceSendNewFieldsCommandArguments[] = {
  "Boolean indicating whether to send new fields.",
  NULL
};

PGM_P PGM emberCommandTablePluginTestHarnessPriceSendSe10FieldsCommandArguments[] = {
  "Boolean indicating whether to send new fields.",
  NULL
};

EmberCommandEntry emberCommandTablePluginTestHarnessPriceCommands[] = {
...
PGM_P PGM emberCommandTablePluginTestHarnessOtaImageMangleCommandArguments[] = {
  "The byte index into the OTA image that will be mangled.",
  NULL
};

EmberCommandEntry emberCommandTablePluginTestHarnessOtaCommands[] = {
...
EmberCommandEntry emberCommandTablePluginTestHarnessKeyUpdateCommands[] = {
...
PGM_P PGM emberCommandTablePluginTestHarnessKeyEstablishmentCertMangleChangeByteCommandArguments[] = {
  "The index of the certificate byte to change",
  "The new value of the certificate byte",
  NULL
};

PGM_P PGM emberCommandTablePluginTestHarnessKeyEstablishmentCertMangleCorruptCommandArguments[] = {
  "The index of the certificate byte to corrupt",
  NULL
};

PGM_P PGM emberCommandTablePluginTestHarnessKeyEstablishmentCertMangleIssuerCommandArguments[] = {
  "The EUI64 of the issuer (big endian).",
  NULL
};

PGM_P PGM emberCommandTablePluginTestHarnessKeyEstablishmentCertMangleLengthCommandArguments[] = {
  "The positive or negative change in length.",
  NULL
};

PGM_P PGM emberCommandTablePluginTestHarnessKeyEstablishmentCertMangleSubjectCommandArguments[] = {
  "The EUI64 of the subject (big endian).",
  NULL
};

EmberCommandEntry emberCommandTablePluginTestHarnessKeyEstablishmentCertMangleCommands[] = {
...
PGM_P PGM emberCommandTablePluginTestHarnessKeyEstablishmentDelayCbkeCommandArguments[] = {
  "Set the actual delay that occurs.",
  "Sets the advertised delay sent to the partner of key establishment",
  NULL
};

PGM_P PGM emberCommandTablePluginTestHarnessKeyEstablishmentKeyMangleCommandArguments[] = {
  "The positive or negative change in length.",
  NULL
};

PGM_P PGM emberCommandTablePluginTestHarnessKeyEstablishmentNewKeyPolicyCommandArguments[] = {
  "Allows / disallows new key establishment requests.",
  NULL
};

PGM_P PGM emberCommandTablePluginTestHarnessKeyEstablishmentOutOfSequenceCommandArguments[] = {
  "The out-of-sequence command ID to send.",
  NULL
};

PGM_P PGM emberCommandTablePluginTestHarnessKeyEstablishmentSetAvailableSuiteCommandArguments[] = {
  "This field holds the type        of key establishment suit ...",
  NULL
};

PGM_P PGM emberCommandTablePluginTestHarnessKeyEstablishmentSuiteCommandArguments[] = {
  "This field holds the type        of key establishment suit ...",
  NULL
};

EmberCommandEntry emberCommandTablePluginTestHarnessKeyEstablishmentCommands[] = {
...
PGM_P PGM emberCommandTablePluginTestHarnessEndpointClusterEndpointIndexCommandArguments[] = {
...
PGM_P PGM emberCommandTablePluginTestHarnessEndpointDisableCommandArguments[] = {
  "The endpoint number.",
  NULL
};

PGM_P PGM emberCommandTablePluginTestHarnessEndpointEnableCommandArguments[] = {
  "The endpoint number.",
  NULL
};

EmberCommandEntry emberCommandTablePluginTestHarnessEndpointCommands[] = {
...
EmberCommandEntry emberCommandTablePluginTestHarnessConcentratorCommands[] = {
...
PGM_P PGM emberCommandTablePluginTestHarnessChannelMaskAddCommandArguments[] = {
  "The 802.15.4 chanel to add.",
  NULL
};

PGM_P PGM emberCommandTablePluginTestHarnessChannelMaskRemoveCommandArguments[] = {
  "The 802.15.4 chanel to remove.",
  NULL
};

EmberCommandEntry emberCommandTablePluginTestHarnessChannelMaskCommands[] = {
#if defined(EMBER_AF_PLUGIN_NETWORK_FIND)
...
PGM_P PGM emberCommandTablePluginTestHarnessAttrOptionsCommandArguments[] = {
  "type",
  "timeout",
  NULL
};

PGM_P PGM emberCommandTablePluginTestHarnessAttrSetDestCommandArguments[] = {
  "addr",
  "endpoint",
  NULL
};

PGM_P PGM emberCommandTablePluginTestHarnessAttrStartTestCommandArguments[] = {
  "cluster id",
  "attr start id",
  "attr end id",
  "client to server",
...
EmberCommandEntry emberCommandTablePluginTestHarnessAttrCommands[] = {
...
PGM_P PGM emberCommandTablePluginTestHarnessApsSecForClusterOnCommandArguments[] = {
  "The cluster ID to add APS security to automatically.",
  NULL
};

EmberCommandEntry emberCommandTablePluginTestHarnessApsSecForClusterCommands[] = {
...
PGM_P PGM emberCommandTablePluginTestHarnessAddChildCommandArguments[] = {
...
EmberCommandEntry emberCommandTablePluginTestHarnessCommands[] = {
...
EmberCommandEntry emberCommandTablePluginStackDiagnosticsCommands[] = {
...
PGM_P PGM emberCommandTablePluginSimpleMeteringClientGetSampledDataCommandArguments[] = {
...
PGM_P PGM emberCommandTablePluginSimpleMeteringClientLocalChangeSupplyCommandArguments[] = {
  "The network address of the server to which the request will be sent.",
  "The local endpoint from which the request will be sent.",
  "The remote endpoint to which the request will be sent.",
...
PGM_P PGM emberCommandTablePluginSimpleMeteringClientSchSnapshotCommandArguments[] = {
  "The network address of the server to which the request will be sent.",
  "The local endpoint from which the request will be sent.",
  "The remote endpoint to which the request will be sent.",
  "The issuerId.",
...
PGM_P PGM emberCommandTablePluginSimpleMeteringClientStartSamplingCommandArguments[] = {
  "The network address of the server to which the request will be sent.",
  "The local endpoint from which the request will be sent.",
  "The remote endpoint to which the request will be sent.",
  "The issuerId.",
...
EmberCommandEntry emberCommandTablePluginSimpleMeteringClientCommands[] = {
...
PGM_P PGM emberCommandTablePluginRulesEngineBdeleteCommandArguments[] = {
  "Incoming device table entry.",
  "Outgoing device table entry.",
  NULL
};

PGM_P PGM emberCommandTablePluginRulesEngineBindCommandArguments[] = {
  "Incoming device table entry.",
  "Outgoing device table entry.",
  NULL
};

PGM_P PGM emberCommandTablePluginRulesEngineEpactionCommandArguments[] = {
  "Incoming Table Entry.",
  "Incoming device endpoint.",
  "Outgoing Table Entry.",
...
PGM_P PGM emberCommandTablePluginRulesEngineEpbindCommandArguments[] = {
  "Incoming device table entry.",
  "Incoming device endpoint.",
  "Outgoing device table entry.",
  "Incoming device endpoint.",
...
EmberCommandEntry emberCommandTablePluginRulesEngineCommands[] = {
  emberCommandEntryActionWithDetails("bclear", rulesEngineBclearCommand, "", "Clear the binding table.", NULL),
  emberCommandEntryActionWithDetails("bdelete", rulesEngineBdeleteCommand, "vv", "Deletes a rule", emberCommandTablePluginRulesEngineBdeleteCommandArguments),
  emberCommandEntryActionWithDetails("bind", emberAfPluginRulesEngineBindCommand, "vv", "Bind inDevice to outDevice so the gateway will re-transmit any incomin ...", emberCommandTablePluginRulesEngineBindCommandArguments),
  emberCommandEntryActionWithDetails("bload", rulesEngineBindLoadCommand, "", "Load the file.", NULL),
  emberCommandEntryActionWithDetails("bprint", rulesEngineBprintCommand, "", "Print the binding table.", NULL),
  emberCommandEntryActionWithDetails("bsave", rulesEngineBindSaveCommand, "", "Save the file.", NULL),
  emberCommandEntryActionWithDetails("clear", rulesEngineClearCommand, "", "Clear the action table.", NULL),
  emberCommandEntryActionWithDetails("epaction", emberAfPluginRulesEngineEndpointActionCommand, "vuvuuubb", "Create an action-based rule that includes endpoints in the lookup mech ...", emberCommandTablePluginRulesEngineEpactionCommandArguments),
  emberCommandEntryActionWithDetails("epbind", emberAfPluginRulesEngineEndpointBindCommand, "vuvu", "Bind inDevice to outDevice so the gateway will re-transmit any incomin ...", emberCommandTablePluginRulesEngineEpbindCommandArguments),
  emberCommandEntryActionWithDetails("load", rulesEngineLoadCommand, "", "Load the file.", NULL),
  emberCommandEntryActionWithDetails("print", rulesEnginePrintCommand, "", "Print the action table.", NULL),
  emberCommandEntryActionWithDetails("save", rulesEngineSaveCommand, "", "Save the file.", NULL),
  emberCommandEntryTerminator()
};

PGM_P PGM emberCommandTablePluginPollControlClientModeCommandArguments[] = {
  "The fast polling mode.",
  NULL
};

PGM_P PGM emberCommandTablePluginPollControlClientRespondCommandArguments[] = {
  "The response mode.",
  NULL
};

PGM_P PGM emberCommandTablePluginPollControlClientTimeoutCommandArguments[] = {
  "The fast polling timeout.",
  NULL
};

EmberCommandEntry emberCommandTablePluginPollControlClientCommands[] = {
...
PGM_P PGM emberCommandTablePluginOtaStorageCommonDataPrintCommandArguments[] = {
  "The index of the image to print its data.",
  "The offset into the OTA image that will be printed.",
  NULL
};

PGM_P PGM emberCommandTablePluginOtaStorageCommonDeleteCommandArguments[] = {
  "The index at which to begin bootloading the image",
  NULL
};

EmberCommandEntry emberCommandTablePluginOtaStorageCommonCommands[] = {
...
PGM_P PGM emberCommandTablePluginOtaServerPolicyBlockRequestCommandArguments[] = {
  "0: Send block (default), 1: Delay download once for 2 minutes, 2: Alwa ...",
  NULL
};

PGM_P PGM emberCommandTablePluginOtaServerPolicyImageReqMinPeriodCommandArguments[] = {
  "The minimum request period in seconds.",
  NULL
};

PGM_P PGM emberCommandTablePluginOtaServerPolicyPageReqMissCommandArguments[] = {
  "0: Upgrade if server has newer (default), 1: Downgrade if server has o ...",
  NULL
};

PGM_P PGM emberCommandTablePluginOtaServerPolicyPageReqSupCommandArguments[] = {
  "0: Upgrade if server has newer (default), 1: Downgrade if server has o ...",
  NULL
};

PGM_P PGM emberCommandTablePluginOtaServerPolicyQueryCommandArguments[] = {
  "0: Upgrade if server has newer (default), 1: Downgrade if server has o ...",
  NULL
};

PGM_P PGM emberCommandTablePluginOtaServerPolicyUpgradeCommandArguments[] = {
  "0: Upgrade Now (default), 1: Upgrade in 2       minutes, 2: Ask me lat ...",
  NULL
};

EmberCommandEntry emberCommandTablePluginOtaServerPolicyCommands[] = {
...
PGM_P PGM emberCommandTablePluginOtaServerLoadFileCommandArguments[] = {
  "The file name.",
  NULL
};

PGM_P PGM emberCommandTablePluginOtaServerNotifyCommandArguments[] = {
...
PGM_P PGM emberCommandTablePluginOtaServerUpgradeCommandArguments[] = {
...
EmberCommandEntry emberCommandTablePluginOtaServerCommands[] = {
#if defined(EMBER_TEST)
...
EmberCommandEntry emberCommandTablePluginIasZoneClientCommands[] = {
...
PGM_P PGM emberCommandTablePluginEzmodeCommissioningServerCommandArguments[] = {
  "The local endpoint.",
  "The identify time in seconds.",
  NULL
};

EmberCommandEntry emberCommandTablePluginEzmodeCommissioningCommands[] = {
...
PGM_P PGM emberCommandTablePluginDeviceTableDiscCommandArguments[] = {
  "Node ID to discover.",
  NULL
};

PGM_P PGM emberCommandTablePluginDeviceTableSendCommandArguments[] = {
  "Out Action data.",
  NULL
};

EmberCommandEntry emberCommandTablePluginDeviceTableCommands[] = {
  emberCommandEntryActionWithDetails("disc", deviceTableDiscoverPresentNodeCommand, "v", "Bind inNodeId to outNodeId so the gateway will re-transmit any incomin ...", emberCommandTablePluginDeviceTableDiscCommandArguments),
...
EmberCommandEntry emberCommandTablePluginConcentratorCommands[] = {
...
EmberCommandEntry emberCommandTablePluginCommands[] = {
  ...
  emberCommandEntrySubMenu("rules-engine", emberCommandTablePluginRulesEngineCommands, ""),
  ...
  emberCommandEntrySubMenu("traffic-test", emberCommandTablePluginTrafficTestCommands, ""),
  emberCommandEntryTerminator()
};

EmberCommandEntry emberCommandTableOptionSecurityApsCommands[] = {
...
PGM_P PGM emberCommandTableOptionSecuritySetAllowTrustCenterRejoinCommandArguments[] = {
  "Whether or not the Trust Center should allow trust center rejoins.",
  NULL
};

EmberCommandEntry emberCommandTableOptionSecurityCommands[] = {
  emberCommandEntrySubMenu("aps", emberCommandTableOptionSecurityApsCommands, ""),
  emberCommandEntryActionWithDetails("set-allow-trust-center-rejoin", optionSecurityAllowTrustCenterRejoin, "u", "Set whether or not a Trust Center application will allow trust center  ...", emberCommandTableOptionSecuritySetAllowTrustCenterRejoinCommandArguments),
  emberCommandEntryTerminator()
};

EmberCommandEntry emberCommandTableOptionPrintRxMsgsCommands[] = {
...
PGM_P PGM emberCommandTableOptionBindingTableSetCommandArguments[] = {
...
EmberCommandEntry emberCommandTableOptionBindingTableCommands[] = {
...
EmberCommandEntry emberCommandTableOptionApsretryCommands[] = {
...
EmberCommandEntry emberCommandTableNetworkFindCommands[] = {
