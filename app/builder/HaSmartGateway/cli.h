...
/** @brief <b>option security set-allow-trust-center-rejoin [allowTrustCenterRejoin:1] </b>
 *   - <i>Set whether or not a Trust Center application will allow trust center rejoins.</i>
 *     - allowTrustCenterRejoin - BOOLEAN - Whether or not the Trust Center should allow trust center rejoins.
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_SECURITY_OPTION_SECURITY_SET_ALLOW_TRUST_CENTER_REJOIN
 ...
 *   - <i>Bind inNodeId to outNodeId so the gateway will re-transmit any incoming command from device in to device out.</i>
 *     - nodeId - INT16U - Node ID to discover.
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_DEVICE_TABLE_PLUGIN_DEVICE_TABLE_DISC

/** @brief <b>plugin device-table send [index:1] </b>
 *   - <i>Send to device in device table.</i>
 *     - index - INT8U - Out Action data.
 */
...
/** @addtogroup plugin-rules-engine Plugin Commands: Rules Engine
 * @ingroup cli
 * The drlc plugin contributes CLI commands to the application framework for
 * adding rules to the
	  local rules engine on the gateway.
 * 
 * @{
 */

/** @brief <b>plugin rules-engine bind [inDevice:2] [outDevice:2] </b>
 *   - <i>Bind inDevice to outDevice so the gateway will re-transmit any incoming command from device in to device out.</i>
 *     - inDevice - INT16U - Incoming device table entry.
 *     - outDevice - INT16U - Outgoing device table entry.
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_RULES_ENGINE_PLUGIN_RULES_ENGINE_BIND

/** @brief <b>plugin rules-engine epbind [inDevice:2] [inEndpoint:1] [outDevice:2] [inEndpoint:1] </b>
 *   - <i>Bind inDevice to outDevice so the gateway will re-transmit any incoming command from device in to device out.  Uses endpoint</i>
 *     - inDevice - INT16U - Incoming device table entry.
 *     - inEndpoint - INT8U - Incoming device endpoint.
 *     - outDevice - INT16U - Outgoing device table entry.
 *     - inEndpoint - INT8U - Incoming device endpoint.
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_RULES_ENGINE_PLUGIN_RULES_ENGINE_EPBIND

/** @brief <b>plugin rules-engine epaction [inNodeId:2] [inEndpoint:1] [outNodeId:2] [outEndpoint:1] [inAction:1] [outAction:1] [inData:-1] [outData:-1] </b>
 *   - <i>Create an action-based rule that includes endpoints in the lookup mechanism.</i>
 *     - inNodeId - INT16U - Incoming Table Entry.
 *     - inEndpoint - INT8U - Incoming device endpoint.
 *     - outNodeId - INT16U - Outgoing Table Entry.
 *     - outEndpoint - INT8U - Outgoing device endpoint.
 *     - inAction - INT8U - Incoming action.
 *     - outAction - INT8U - Outgoing action.
 *     - inData - OCTET_STRING - In Action data.
 *     - outData - OCTET_STRING - Out Action data.
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_RULES_ENGINE_PLUGIN_RULES_ENGINE_EPACTION

/** @brief <b>plugin rules-engine save </b>
 *   - <i>Save the file.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_RULES_ENGINE_PLUGIN_RULES_ENGINE_SAVE

/** @brief <b>plugin rules-engine load </b>
 *   - <i>Load the file.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_RULES_ENGINE_PLUGIN_RULES_ENGINE_LOAD

/** @brief <b>plugin rules-engine print </b>
 *   - <i>Print the action table.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_RULES_ENGINE_PLUGIN_RULES_ENGINE_PRINT

/** @brief <b>plugin rules-engine clear </b>
 *   - <i>Clear the action table.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_RULES_ENGINE_PLUGIN_RULES_ENGINE_CLEAR

/** @brief <b>plugin rules-engine bsave </b>
 *   - <i>Save the file.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_RULES_ENGINE_PLUGIN_RULES_ENGINE_BSAVE

/** @brief <b>plugin rules-engine bload </b>
 *   - <i>Load the file.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_RULES_ENGINE_PLUGIN_RULES_ENGINE_BLOAD

/** @brief <b>plugin rules-engine bprint </b>
 *   - <i>Print the binding table.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_RULES_ENGINE_PLUGIN_RULES_ENGINE_BPRINT

/** @brief <b>plugin rules-engine bclear </b>
 *   - <i>Clear the binding table.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_RULES_ENGINE_PLUGIN_RULES_ENGINE_BCLEAR

/** @brief <b>plugin rules-engine bdelete [inDevice:2] [outDevice:2] </b>
 *   - <i>Deletes a rule</i>
 *     - inDevice - INT16U - Incoming device table entry.
 *     - outDevice - INT16U - Outgoing device table entry.
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_RULES_ENGINE_PLUGIN_RULES_ENGINE_BDELETE

/** @} */ // end group plugin-rules-engine
...
/** @addtogroup plugin-traffic-test Plugin Commands: Traffic Test
 * @ingroup cli
 * The commands for testing traffic on a network.
 * 
 * @{
 */

/** @brief <b>plugin traffic-test on-off [deviceEntry:2] [msBetweenToggles:2] [numMessages:2] </b>
 *   - <i>Start the on/off test.</i>
 *     - deviceEntry - INT16U
 *     - msBetweenToggles - INT16U
 *     - numMessages - INT16U
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_TRAFFIC_TEST_PLUGIN_TRAFFIC_TEST_ON_OFF

/** @brief <b>plugin traffic-test level [deviceEntry:2] [msBetweenToggles:2] [numMessages:2] </b>
 *   - <i>Start the level test.</i>
 *     - deviceEntry - INT16U
 *     - msBetweenToggles - INT16U
 *     - numMessages - INT16U
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_TRAFFIC_TEST_PLUGIN_TRAFFIC_TEST_LEVEL

/** @} */ // end group plugin-traffic-test
...
/** @brief <b>zcl color-control movetohue [hue:1] [direction:1] [transitionTime:2] </b>
...
/** @brief <b>zcl color-control movehue [moveMode:1] [rate:1] </b>
...
/** @brief <b>zcl color-control stephue [stepMode:1] [stepSize:1] [transitionTime:1] </b>
...
/** @brief <b>zcl color-control movetosat [saturation:1] [transitionTime:2] </b>
...
/** @brief <b>zcl color-control movesat [moveMode:1] [rate:1] </b>
...
/** @brief <b>zcl color-control stepsat [stepMode:1] [stepSize:1] [transitionTime:1] </b>
...
/** @brief <b>zcl color-control movetohueandsat [hue:1] [saturation:1] [transitionTime:2] </b>
...
/** @brief <b>zcl color-control movetocolor [colorX:2] [colorY:2] [transitionTime:2] </b>
...
/** @brief <b>zcl color-control movecolor [rateX:2] [rateY:2] </b>
 *   - <i>Moves the color.</i>
 *     - rateX - INT16S
 *     - rateY - INT16S
 */
...
/** @brief <b>zcl color-control stepcolor [stepX:2] [stepY:2] [transitionTime:2] </b>
...
/** @brief <b>zcl color-control movetocolortemp [colorTemperature:2] [transitionTime:2] </b>
 *   - <i>Moves the lighting to a specific color temperature.</i>
...
/** @brief <b>zcl color-control stopmovestep </b>
 *   - <i>Command description for StopMoveStep</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_COLOR_CONTROL_STOPMOVESTEP

/** @brief <b>zcl color-control movecolortemp [moveMode:1] [rate:2] [colorTemperatureMinimum:2] [colorTemperatureMaximum:2] </b>
...
/** @brief <b>zcl color-control stepcolortemp [stepMode:1] [stepSize:2] [transitionTime:2] [colorTemperatureMinimum:2] [colorTemperatureMaximum:2] </b>
 *   - <i>Command description for StepColorTemperatue</i>
 *     - stepMode - HueStepMode [ENUM8]
 *     - stepSize - INT16U
 *     - transitionTime - INT16U
 *     - colorTemperatureMinimum - INT16U
